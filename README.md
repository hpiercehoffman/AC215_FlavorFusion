...
Looking at the summaries generated by the pruned model, we can see that the summaries make less sense and are less relevant to the input reviews. We show an example below:
